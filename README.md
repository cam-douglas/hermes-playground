...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Spandrel is featured this hour
...
- `products/spandrel/` — featured this-hour product prototype
