...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Flute is the featured instrument this hour
...
- `products/flute/` — featured this-hour product prototype
