...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Crook is the featured instrument this hour
...
- `products/crook/` — featured this-hour product prototype
