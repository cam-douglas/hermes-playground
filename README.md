...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Crotch is the featured instrument this hour
...
- `products/crotch/` — featured this-hour product prototype
