...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Dowel is the featured instrument this hour
...
- `products/dowel/` — featured this-hour product prototype
