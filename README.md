...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Burl is the featured instrument this hour
...
- `products/burl/` — featured this-hour product prototype
