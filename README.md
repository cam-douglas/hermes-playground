...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Ring is the featured instrument this hour
...
- `products/ring/` — featured this-hour product prototype
