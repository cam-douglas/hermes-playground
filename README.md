...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Glide is featured this hour
...
- `products/glide/` — featured this-hour product prototype
