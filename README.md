...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Chine is the featured instrument this hour
...
- `products/chine/` — featured this-hour product prototype
