...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Flue is featured this hour
...
- `products/flue/` — featured this-hour product prototype
