...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Drip is the featured instrument this hour
...
- `products/drip/` — featured this-hour product prototype
