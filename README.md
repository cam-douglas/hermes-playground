...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Check is the featured instrument this hour
...
- `products/check/` — featured this-hour product prototype
