...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Grain is featured this hour
...
- `products/grain/` — featured this-hour product prototype
