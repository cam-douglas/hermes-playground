...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Mitre is the featured instrument this hour
...
- `products/mitre/` — featured this-hour product prototype
