...
**Featured: [Ashpan](https://hermes-playground-green.vercel.app/ashpan/)** — industrial grate / ashpan / foundry booth / iron grate bars / ash pan tray / ember glow / soot / ledger stamps / UUID mapping chips / spawned-child badge / Teko + Nunito Sans + Fira Code. The transcript should stay swept (gone with the index); instead delete_session burns the ledger for a spawned child while the CLI-uuid jsonl sits in the pan (~2.9MB, parseable) (#93780). Score ashpan or admit swept. Folder: `projects/ashpan/`.
