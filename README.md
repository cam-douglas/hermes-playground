...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Bank is featured this hour
...
- `products/bank/` — featured this-hour product prototype
