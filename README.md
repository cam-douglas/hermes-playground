...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Heart is the featured instrument this hour
...
- `products/heart/` — featured this-hour product prototype
