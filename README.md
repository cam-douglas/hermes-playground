...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Freeboard is featured this hour
...
- `products/freeboard/` — featured this-hour product prototype
