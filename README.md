...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Dovetail is the featured instrument this hour
...
- `products/dovetail/` — featured this-hour product prototype
