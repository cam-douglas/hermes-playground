...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Chamfer is the featured instrument this hour
...
- `products/chamfer/` — featured this-hour product prototype
