...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Twist is the featured instrument this hour
...
- `products/twist/` — featured this-hour product prototype
