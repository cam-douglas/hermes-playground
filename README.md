...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Spline is the featured instrument this hour
...
- `products/spline/` — featured this-hour product prototype
