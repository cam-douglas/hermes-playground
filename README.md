...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Lintel is featured this hour
...
- `products/lintel/` — featured this-hour product prototype
