...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Parapet is featured this hour
...
- `products/parapet/` — featured this-hour product prototype
