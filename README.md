...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Reveal is featured this hour
...
- `products/reveal/` — featured this-hour product prototype
