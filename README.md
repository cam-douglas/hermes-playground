...
**Featured: [Tmesis](https://hermes-playground-green.vercel.app/tmesis/)** — manuscript / rhetoric / spliced parchment / editorial desk / open folio / advisor ink / slash-command ribbon booth / Cormorant Garamond + Source Sans 3 + IBM Plex Mono. The folio should stay contiguous (defer local_command until the open assistant message has closed); instead a slash command (/effort) typed while advisor is in flight splices local_command records mid-message, breaks parentUuid, and permanently 400s the session (#86198). Score tmesis or admit contiguous. Folder: `projects/tmesis/`.
