...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Keystone is featured this hour
...
- `products/keystone/` — featured this-hour product prototype
