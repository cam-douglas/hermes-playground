...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Yaw is featured this hour
...
- `products/yaw/` — featured this-hour product prototype
