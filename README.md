...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Pith is the featured instrument this hour
...
- `products/pith/` — featured this-hour product prototype
