...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Mortise is the featured instrument this hour
...
- `products/mortise/` — featured this-hour product prototype
