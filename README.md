...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Corbel is featured this hour
...
- `products/corbel/` — featured this-hour product prototype
