...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Ribbon is the featured instrument this hour
...
- `products/ribbon/` — featured this-hour product prototype
