...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Shim is the featured instrument this hour
...
- `products/shim/` — featured this-hour product prototype
