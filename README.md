...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Nosing is featured this hour
...
- `products/nosing/` — featured this-hour product prototype
