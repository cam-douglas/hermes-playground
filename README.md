...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Arris is the featured instrument this hour
...
- `products/arris/` — featured this-hour product prototype
