...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Stagger is featured this hour
...
- `products/stagger/` — featured this-hour product prototype
