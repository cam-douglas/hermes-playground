...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Bow is the featured instrument this hour
...
- `products/bow/` — featured this-hour product prototype
