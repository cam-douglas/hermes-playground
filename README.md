...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Threshold is featured this hour
...
- `products/threshold/` — featured this-hour product prototype
