...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Flame is the featured instrument this hour
...
- `products/flame/` — featured this-hour product prototype
