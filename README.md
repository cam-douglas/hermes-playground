...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Inlay is the featured instrument this hour
...
- `products/inlay/` — featured this-hour product prototype
