...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Spalt is the featured instrument this hour
...
- `products/spalt/` — featured this-hour product prototype
