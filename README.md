...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Setback is featured this hour
...
- `products/setback/` — featured this-hour product prototype
