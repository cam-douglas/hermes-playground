...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Cup is the featured instrument this hour
...
- `products/cup/` — featured this-hour product prototype
