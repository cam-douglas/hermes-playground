...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Pecky is the featured instrument this hour
...
- `products/pecky/` — featured this-hour product prototype
