...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Cambium is the featured instrument this hour
...
- `products/cambium/` — featured this-hour product prototype
