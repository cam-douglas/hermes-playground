...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Eye is the featured instrument this hour
...
- `products/eye/` — featured this-hour product prototype
