...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Stain is the featured instrument this hour
...
- `products/stain/` — featured this-hour product prototype
