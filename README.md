...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Soffit is the featured instrument this hour
...
- `products/soffit/` — featured this-hour product prototype
