...
- **Offcut** (featured this hour · 20 Aug 2026, 18:50 Sydney) — one stock bar, placed cuts, leftover length after kerf. `products/offcut/` · workshop, stock, cut
...
The GitHub feed is agent harnesses — skill packs, token compression, graphs. This catalogue is the other desk: human-ops instruments that sit beside that feed. Clocks, leftover-access boards, paste wells, fluency maps, a floor plan of empty booked rooms, a tide of sentence lengths, a stick that shows the offcut. Local-first, no backend, no new cron.
