...
**Featured: [Analepsis](https://hermes-playground-green.vercel.app/analepsis/)** — manuscript flashback / collation-desk booth / verso folio / recto gathering / splice gutter / dusk horizon / stuck quill / Libre Baskerville + Figtree + IBM Plex Mono. A Desktop Code-tab feed should stay ordered (disk, React tree, and bottom-anchored list agree; latest result at the bottom); instead a synthetic `background_tasks_redelivered` marker splices the 18:32–19:24 stretch after 22:30 so the reader lands on an hours-earlier turn and the working marker sticks (#93569). Score analepsis or admit ordered. Folder: `projects/analepsis/`.
