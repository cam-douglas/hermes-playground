...
**Featured: [Agraphia](https://hermes-playground-green.vercel.app/agraphia/)** — clinical agraphia / neurology writing-desk / speech-intact vs writing-hand / chart-clipboard / quill-lift booth / Crimson Pro + Outfit + JetBrains Mono. The chart should stay penned (pre-tool assistant text still written into session JSONL; hooks can read the marker); instead interactive CLI 2.1.270 omits most assistant text blocks before a tool_use while the terminal still shows the words, and hooks reading transcript_path go blind (#94251). Score agraphia or admit penned. Folder: `projects/agraphia/`.
