...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Fascia is the featured instrument this hour
...
- `products/fascia/` — featured this-hour product prototype
