...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Sap is the featured instrument this hour
...
- `products/sap/` — featured this-hour product prototype
