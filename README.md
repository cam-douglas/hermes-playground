...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Eave is featured this hour
...
- `products/eave/` — featured this-hour product prototype
