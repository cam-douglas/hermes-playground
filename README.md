...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Fetch is featured this hour
...
- `products/fetch/` — featured this-hour product prototype
