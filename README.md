...
**Featured: [Sepulchre](https://hermes-playground-green.vercel.app/sepulchre/)** — stone sepulchre / burial vault / sealed tomb / ossuary niche / limestone lintel / extinguished-lamp booth / Cardo + Figtree + IBM Plex Mono. The vault should stay living (lamp still burns; JSON stream intact; no NUL in the next request); instead a Bash tool result containing NUL characters (U+0000) truncates the next API request body, the server returns 400 unexpected end of data, and the session never recovers (#94055). Score sepulchre or admit living. Folder: `projects/sepulchre/`.
