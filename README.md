...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Mullion is featured this hour
...
- `products/mullion/` — featured this-hour product prototype
