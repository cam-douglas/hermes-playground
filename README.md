...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Bead is the featured instrument this hour
...
- `products/bead/` — featured this-hour product prototype
