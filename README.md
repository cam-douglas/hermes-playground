...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Scarf is featured this hour
...
- `products/scarf/` — featured this-hour product prototype
