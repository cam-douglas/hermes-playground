...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Fillet is the featured instrument this hour
...
- `products/fillet/` — featured this-hour product prototype
