...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Curl is the featured instrument this hour
...
- `products/curl/` — featured this-hour product prototype
