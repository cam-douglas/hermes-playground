...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Mottle is the featured instrument this hour
...
- `products/mottle/` — featured this-hour product prototype
