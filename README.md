...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Cant is featured this hour
...
- `products/cant/` — featured this-hour product prototype
