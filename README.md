...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Swing is featured this hour
...
- `products/swing/` — featured this-hour product prototype
