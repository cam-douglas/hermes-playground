...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Coaming remains the featured instrument; this hour adds no catalog object
...
- `products/coaming/` — featured this-hour product prototype
