...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Crown is featured this hour
...
- `products/crown/` — featured this-hour product prototype
