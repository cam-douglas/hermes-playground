...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Flame remains the featured instrument; this hour is Sky row (structure)
