...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Tenon is the featured instrument this hour
...
- `products/tenon/` — featured this-hour product prototype
