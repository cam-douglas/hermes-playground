...
**Featured: [Pontoon](https://hermes-playground-green.vercel.app/pontoon/)** — harbor pontoon / floating-bridge pier / timber decking / salt fog / navigation lights / rope / tide marks / ink navy / wet timber / fog silver / nav-light amber / rope tan / Petrona + Figtree + Azeret Mono. Remote Control bridges should stay afloat after a Desktop restart; instead stealth relaunch / onQuitCleanup washes every session bridge while the sidebar still looks intact, and the phone list is empty (#93288). Score pontoon or admit afloat. Folder: `projects/pontoon/`.
