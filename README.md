...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Plinth is featured this hour
...
- `products/plinth/` — featured this-hour product prototype
