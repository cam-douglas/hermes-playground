...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Knot is the featured instrument this hour
...
- `products/knot/` — featured this-hour product prototype
