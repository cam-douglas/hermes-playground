...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Slew is featured this hour
...
- `products/slew/` — featured this-hour product prototype
