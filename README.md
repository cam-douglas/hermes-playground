...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Quilt is the featured instrument this hour
...
- `products/quilt/` — featured this-hour product prototype
