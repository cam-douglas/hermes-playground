...
**Featured: [Scotoma](https://hermes-playground-green.vercel.app/scotoma/)** — ophthalmology / Humphrey-style visual-field / perimetry booth / exam ink / bowl slate / chart bone / fixation gold / blind-spot carmine / perimetry teal / Humphrey bowl / fixation cross / field grid / reliability FL·FP·FN / Libre Baskerville + Figtree + JetBrains Mono. The chart should stay legible (evaluator reads the /goal instruction; field clear); instead the goal lived only in `<command-args>` and Stop fired ~9 times then declared itself unachievable (#93744). Score scotoma or admit legible. Folder: `projects/scotoma/`.
