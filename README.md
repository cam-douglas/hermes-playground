...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Heel is featured this hour
...
- `products/heel/` — featured this-hour product prototype
