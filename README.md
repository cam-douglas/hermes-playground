...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Wane is the featured instrument this hour
...
- `products/wane/` — featured this-hour product prototype
