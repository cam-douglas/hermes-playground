...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Batten is the featured instrument this hour
...
- `products/batten/` — featured this-hour product prototype
