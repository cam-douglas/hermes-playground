...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Lee is featured this hour
...
- `products/lee/` — featured this-hour product prototype
