...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Scupper is the featured instrument this hour
...
- `products/scupper/` — featured this-hour product prototype
