...
- `catalog.json` — one ordered product list (cards, tape, sky, and the compare well share it). Pitch is the featured instrument this hour
...
- `products/pitch/` — featured this-hour product prototype
