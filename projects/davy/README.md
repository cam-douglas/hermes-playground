...
- Same-class (cite, not primary): [#85583](https://github.com/anthropics/claude-code/issues/85583) stale /tui renderer report; Deadband [#90789](https://github.com/anthropics/claude-code/issues/90789) settings.json 5s echo; Carrel [#90661](https://github.com/anthropics/claude-code/issues/90661) launch.json last-writer-wins; [#88977](https://github.com/anthropics/claude-code/issues/88977) concurrent session spawns deadlock on `.claude.json` lock; [#78439](https://github.com/anthropics/claude-code/issues/78439) concurrent-write corruption of `.claude.json` (13 concurrent processes; healthy 57,162 B → 50 B skeleton); [#85461](https://github.com/anthropics/claude-code/issues/85461) one global `lastReleaseNotesSeen` consumed by concurrent sessions; [#73719](https://github.com/anthropics/claude-code/issues/73719) fullscreen preference overridden / force-enabled on background attach; [#90733](https://github.com/anthropics/claude-code/issues/90733) fullscreen hides slash-command output until next repaint (2.1.251). Cross-ecosystem: [openai/codex#24224](https://github.com/openai/codex/issues/24224), [openai/codex#37226](https://github.com/openai/codex/issues/37226), [openai/codex#39642](https://github.com/openai/codex/issues/39642), [openai/codex#40109](https://github.com/openai/codex/issues/40109) two concurrent rollout writers race on shared durable ordinals.
- Nearby TUI (boundary only): #88372 scrollbar, #84940 userMessageBackground, #76022 hyperlinks twice, #85573 assistant text dropped, #82886 mouse selection, #85712 mouse wheel no-op, #78693 SGR leak. Backups (do not ship): Cartouche/Chimera [#90881](https://github.com/anthropics/claude-code/issues/90881), Gyre [#90800](https://github.com/anthropics/claude-code/issues/90800). Reject [#90889](https://github.com/anthropics/claude-code/issues/90889) (Limpet clone).
