...
Empty stdin uses the seeded #90856 regrown ticket. Stdout is JSON: `verdict`, `chips[]`, `reasons[]`, `excised`, `regrown`, `hold`, `alarm`, `idleWord`.

- **EXCISED** if gone from settings AND known AND clone absent
...
Primary: [anthropics/claude-code#90856](https://github.com/anthropics/claude-code/issues/90856). Corroborators (same-class pain, not primary): #82064, #77937, #87778, #86428, #87651.
