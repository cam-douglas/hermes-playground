...
- **cousins** = cite-only #76615, #38722 (stale-closed priors), #76080, #93747
...
- Cite-only cousins: #76615, #38722 (stale-closed priors of this same version-path TCC accumulation); #76080 (permission prompt shows version string as app name); #93747 (Desktop Documents EPERM / fragmented duplicate claude identities). Do not rebuild as separate booths.
