...
test("51 catalog wiring: 34 products, Leat featured, Pleat listed", () => {
...
test("53 hours.json keeps the 05:50 Sydney Pleat ship after Shunt and Sump", () => {
  ...
  assert.equal(hours[2].stem, "2026-08-29-sump");
  assert.ok(hours.some((row) => row.stem === "2026-08-29-pleat"));
