...
- **cousins** = cite-only #73443 #73320 — do not rebuild; do not conflate
...
- Cousins (cite-only — do NOT rebuild / do NOT conflate): #73443 closed 2026-08-17 — footer nav re-enabled mouse; same stated root cause (attached sessions ignored mouse opt-outs). #73320 open — DO_NOT_TRACK silently disables mouse clicks (different mechanism). Direct-launch with DISABLE_MOUSE=1 is the working control. #94029 is specifically attach ignoring both documented mouse opt-outs.
